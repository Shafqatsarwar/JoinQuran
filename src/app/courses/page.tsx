    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="p-6 rounded-lg shadow-lg bg-white">
          ...
          <h3 className="text-2xl font-bold text-yellow-500 mb-2">These courses include:</h3>
        ...
        <div className="p-6 rounded-lg shadow-lg bg-white">
          ...
          <h3 className="text-2xl font-bold text-yellow-500 mb-2">This course includes:</h3>
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>Tajweed (Pronunciation of Holy Quran with the rules of Tajweed)</li>
            <li>Memorization of five time daily Prayers.</li>
            <li>Method of Funeral and Eid Prayers.</li>
