  ...
  return (
    <div className="container mx-auto px-4 py-16 text-dark-text">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="bg-dark-surface p-8 rounded-2xl shadow-xl border border-gray-700 transform transition-all hover:scale-105">
          <div className="mb-6">
          ...
          <h2 className="text-2xl font-semibold text-white mb-4">JoinQuran FAQ Guide</h2>
